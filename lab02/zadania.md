...
3. **NA DODATKOWY PUNKT** Napisz skrypt, który wspomoże biednego wykładowcę w sprawdzaniu kolokwiów. W katalogu znajdują się 32 pliki cpp, nazywające się zgodnie ze wzorem - [nrindeksu]_z1.cpp. Zadanie, które będzie sprawdzane poległo na wczytaniu od użytkownika liczby <25 i wydrukowaniu jej silni. Biedny wykładowca chciałby aby:
	1. Wyświetlony na górze ekranu został nr indeksu studenta bez rozszerzenia oraz numeru zadania
	2. Poniżej wyniki wywołania sprawdzanego zadania na wartościach 5, 10 i 30
	3. Skrypt umożliwił mu wpisanie liczby punktów za zadanie i umieszczenie jej wraz z **SAMYM** nr indeksu w pliku tekstowym lub wyświetlenie kodu zadania w razie wątpliwości
	4. Po wpisaniu oceny powinien przejść automatycznie do następnego studenta.