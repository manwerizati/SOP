Zadania do laboratorium 3 SOP
=============================

1.  Napisz skrypt, który przeskanuje katalog Dokumenty i podkatalogi w poszukiwaniu plików .txt i wyświetli ich pełną listę
2.  Poprzedni skrypt rozszerz o pakowanie tego zestawu do skompresowanego pliku o nazwie “\[user\]\_backup\_\[data\_wykonania\]”. Takie backupy powinny być umieszczone w katalogu ~/.backups
